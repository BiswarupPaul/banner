                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row mb-3">
                                ...
                                <div class=" col-md-2">
                                    <a href="banner.php" class="btn btn-primary">Add Banner</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        if($num_rows > 0)
                                        {
                                            ...
                                            foreach ($result as $row)
                                            {
                                                ...
                                                <th>
                                                    ...
                                                    <a href="banner.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
                                                    <a href="banner.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Delete</a>
                                                </th>
